<?php
/*
Template Name: Sustainability Stories, Planet
*/
?>
...
<?php
 get_header(null, array('css_files' => array(
    // \assets\css\
    'sustainability-css/stories-press-release-styles',
...
<div class="menu-container">
    ...
    <a class="nav-link active" aria-current="page" href="http://jollibeegroup.local/stories-press-release">Press Release</a>
...
<div class="menu-container-dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
        ...
        <li><a class="dropdown-item" href="http://jollibeegroup.local/stories/">Food</a></li>
    </ul>
</div>

<!-- ----------------STORIES MENU TAB --------------------------->
<div id="press-release-card-container" class="press-release-card-container">
    <div class="card">
...
<div class="pagination-container">
  <ul id="pagination">
    ...
    <li><a href="http://jollibeegroup.local/stories-press-release" class="active">4</a></li>

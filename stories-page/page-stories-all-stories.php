<?php
/*
Template Name: Sustainability Stories, All, Stories
*/
?>
...
<?php
 get_header(null, array('css_files' => array(
    // \assets\css\
    'sustainability-css/stories-all-stories-styles',
...
<div class="menu-container">
    ...
    <a class="nav-link" href="#">Planet</a>
    <a class="nav-link" href="http://jollibeegroup.local/stories-press-release">Press Release</a>
    <a class="nav-link active" aria-current="page"  href="#">All Stories</a>
    </nav>
</div>
...
<!-- ----------------STORIES MENU TAB --------------------------->
<div id="all-stories-card-container" class="all-stories-card-container">
    <div class="card">
